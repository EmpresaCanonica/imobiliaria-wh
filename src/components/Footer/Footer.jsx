  ...
  return (
    <div id='Informacoes' className='w-full bg-primary-dark-brown md:h-[21rem] h-[18rem] flex flex-col items-center justify-center '>
        ...
        <div className=' flex justify-between w-full md:px-[4rem] px-[1rem] items-center md:h-[13rem] h-[10rem] '>
            <div className='md:w-[15rem] w-[12rem] h-full flex flex-col justify-between'>
                <Image
                    className='w-full '
                    src={LogoH}
                    alt='Logo'
                ...
                <h3 className='md:text-medium text-sm text-detail-light-beige text-justify'>
                    Cada chave que entregamos é a porta para um novo capítulo na sua vida.
                </h3>
            </div>

            <div className='w-[15rem] md:text-medium text-sm h-full flex flex-col justify-between text-detail-light-beige'>
                <h1>
