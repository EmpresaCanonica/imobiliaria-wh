...
export default function HeroSection (){
    return(
        ...
        <div className="flex-col flex  w-[70.5rem] justify-center h-full text-black ">
            {/* Bloco de Destaque */}
            <div className='w-[30rem] md:pl-0 pl-[2rem]'>
                {/* Texto */}
                <div className="pb-[4rem]">
                    <h1 className="text-4xl text-praimary-light-brown font-bold pb-2">
                        Seu próximo lar está a um clique de distância. Vamos encontrá-lo juntos!
                    </h1>
                    <h3 className="text-detail-beige w-[60%] md:w-[100%]">
                        Entre em contato e encontre o lugar ideal para chamar de lar!
                    </h3>
                </div>
                {/* Botões */}
                <div className=" mb-[4rem]">
                    <Button className="bg-detail-beige text-off " endContent={<FaCircleArrowDown/>}>
                        Entre em Contato
                    </Button>   
                    <Button className="bg-detail-beige text-off mx-4 " endContent={<FaCircleArrowDown/>}>
                        Sobre nós
                    </Button>   
                </div>
                {/* Imagens */}
