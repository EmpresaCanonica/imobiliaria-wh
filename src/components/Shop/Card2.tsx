...
export default function Card({ name, text1, text2, image1, image2 }: Props) {
  return (
    <div className='flex h-full w-full flex-col md:flex-row'>
      ...
      <div className='flex flex-col w-full md:w-[50%] h-full my-auto justify-between text-right md:px-0 px-10'>
        <h1 className='md:py-[1rem] py-[0.4rem] text-black text-2xl md:text-3xl border-r-8 px-2 border-praimary-light-brown'>
          {name}
        </h1>

        <h2 className='md:py-[1rem] py-[0.4rem] text-black text-xl md:text-2xl px-5'>
          {text1}
        </h2>

        <h3 className='md:py-[1rem] py-[0.4rem] text-black text-xs md:text-sm px-5'>
          {text2}
        </h3>
